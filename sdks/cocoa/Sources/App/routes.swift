...
func routes(_ app: Application) throws {
    ...
    app.get("introspect") { req -> Response in
        let options: [[String: AnyCodable]] = [
            ...
            ["key": AnyCodable("profilesSampleRate"), "canonicalKey": AnyCodable("profilesSampleRate"), "type": AnyCodable("float"), "required": AnyCodable(false), "default": AnyCodable(NSNull()), "description": AnyCodable("Profiles sample rate")],
            ["key": AnyCodable("tracesSampler"), "canonicalKey": AnyCodable("tracesSampler"), "type": AnyCodable("function"), "required": AnyCodable(false), "default": AnyCodable(NSNull()), "description": AnyCodable("Custom traces sampler function")],
            ["key": AnyCodable("appHangTimeoutInterval"), "canonicalKey": AnyCodable("appHangTimeoutInterval"), "type": AnyCodable("float"), "required": AnyCodable(false), "default": AnyCodable(2.0), "description": AnyCodable("App hang timeout interval in seconds")],
            ["key": AnyCodable("releaseName"), "canonicalKey": AnyCodable("releaseName"), "type": AnyCodable("string"), "required": AnyCodable(false), "default": AnyCodable(NSNull()), "description": AnyCodable("Release name")],
            ["key": AnyCodable("beforeSendTransaction"), "canonicalKey": AnyCodable("beforeSendTransaction"), "type": AnyCodable("function"), "required": AnyCodable(false), "default": AnyCodable(NSNull()), "description": AnyCodable("Hook before sending transaction")],
            ["key": AnyCodable("attachScreenshot"), "canonicalKey": AnyCodable("attachScreenshot"), "type": AnyCodable("boolean"), "required": AnyCodable(false), "default": AnyCodable(false), "description": AnyCodable("Attach screenshot on error")],
            ["key": AnyCodable("attachViewHierarchy"), "canonicalKey": AnyCodable("attachViewHierarchy"), "type": AnyCodable("boolean"), "required": AnyCodable(false), "default": AnyCodable(false), "description": AnyCodable("Attach view hierarchy on error")],
            ["key": AnyCodable("enableCaptureFailedRequests"), "canonicalKey": AnyCodable("enableCaptureFailedRequests"), "type": AnyCodable("boolean"), "required": AnyCodable(false), "default": AnyCodable(false), "description": AnyCodable("Capture failed HTTP requests")],
            ["key": AnyCodable("failedRequestStatusCodes"), "canonicalKey": AnyCodable("failedRequestStatusCodes"), "type": AnyCodable("list"), "required": AnyCodable(false), "default": AnyCodable(NSNull()), "description": AnyCodable("HTTP status codes for failed request capture")],
            ["key": AnyCodable("enableNetworkBreadcrumbs"), "canonicalKey": AnyCodable("enableNetworkBreadcrumbs"), "type": AnyCodable("boolean"), "required": AnyCodable(false), "default": AnyCodable(true), "description": AnyCodable("Enable network breadcrumbs")],
            ["key": AnyCodable("enableNetworkTracking"), "canonicalKey": AnyCodable("enableNetworkTracking"), "type": AnyCodable("boolean"), "required": AnyCodable(false), "default": AnyCodable(true), "description": AnyCodable("Enable network tracking spans")],
            ["key": AnyCodable("enableUIViewControllerTracing"), "canonicalKey": AnyCodable("enableUIViewControllerTracing"), "type": AnyCodable("boolean"), "required": AnyCodable(false), "default": AnyCodable(true), "description": AnyCodable("Enable UIViewController tracing")],
        ]
